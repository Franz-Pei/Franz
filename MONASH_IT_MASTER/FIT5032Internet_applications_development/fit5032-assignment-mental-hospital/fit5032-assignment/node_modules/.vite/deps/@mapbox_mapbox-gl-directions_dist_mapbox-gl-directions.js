...
var require_mapbox_gl_directions = __commonJS({
  "node_modules/@mapbox/mapbox-gl-directions/dist/mapbox-gl-directions.js"(exports, module) {
    (function(f) {
      ...
      return (/* @__PURE__ */ function() {
      ...
      }, { "lodash._reinterpolate": 9, "lodash.templatesettings": 13 }], 13: [function(require2, module3, exports3) {
        (function(global2) {
          (function() {
      ...
      }, { "lodash._reinterpolate": 9 }], 14: [function(require2, module3, exports3) {
        "use strict";
        const isOptionObject = require2("is-plain-obj");
      ...
      }, { "is-plain-obj": 15 }], 15: [function(require2, module3, exports3) {
        "use strict";
        ...
        module3.exports = Suggestions;
      }, { "./list": 20, "fuzzy": 8, "xtend": 24 }], 22: [function(require2, module3, exports3) {
        ...
        function fetchDirections() {
          return function(dispatch, getState) {
            var _getState = getState(), api = _getState.api, accessToken = _getState.accessToken, routeIndex = _getState.routeIndex, profile = _getState.profile, alternatives = _getState.alternatives, congestion = _getState.congestion, destination = _getState.destination, language = _getState.language, exclude = _getState.exclude, fetchDirectionsRequest = _getState.fetchDirectionsRequest;
        ...
        function clearDestination() {
          return function(dispatch, getState) {
            var _getState2 = getState(), fetchDirectionsRequest = _getState2.fetchDirectionsRequest;
            if (fetchDirectionsRequest) {
              fetchDirectionsRequest.abort();
            }
            dispatch({
        ...
        function createOrigin(coordinates) {
          return function(dispatch, getState) {
            var _getState3 = getState(), destination = _getState3.destination;
        ...
        function createDestination(coordinates) {
          return function(dispatch, getState) {
            var _getState4 = getState(), origin = _getState4.origin;
        ...
        function setProfile(profile) {
          return function(dispatch, getState) {
            var _getState5 = getState(), origin = _getState5.origin, destination = _getState5.destination;
            dispatch({
        ...
        function removeWaypoint(waypoint) {
          return function(dispatch, getState) {
            var _getState8 = getState(), destination = _getState8.destination, waypoints = _getState8.waypoints;
        ...
        function eventEmit(type, data) {
          var _this = this;
          return function(dispatch, getState) {
            var _getState10 = getState(), events = _getState10.events;
            if (!events[type]) {
              return {
                type: types.EVENTS,
                events
        ...
        exports3.WAYPOINTS = exports3.SET_OPTIONS = exports3.ROUTE_INDEX = exports3.ORIGIN_QUERY = exports3.ORIGIN_FROM_COORDINATES = exports3.ORIGIN_CLEAR = exports3.ORIGIN = exports3.HOVER_MARKER = exports3.EVENTS = exports3.ERROR = exports3.DIRECTIONS_REQUEST_START = exports3.DIRECTIONS_PROFILE = exports3.DIRECTIONS = exports3.DESTINATION_QUERY = exports3.DESTINATION_FROM_COORDINATES = exports3.DESTINATION_CLEAR = exports3.DESTINATION = void 0;
        ...
        exports3.DIRECTIONS_REQUEST_START = DIRECTIONS_REQUEST_START;
        ...
        ;
      }, { "../utils": 34, "events": 7, "lodash.debounce": 10, "suggestions": 19 }], 28: [function(require2, module3, exports3) {
        "use strict";
        Object.defineProperty(exports3, "__esModule", {
          value: true
        });
      ...
      }, { "./geocoder": 27, "lodash.isequal": 11, "lodash.template": 12, "turf-extent": 22 }], 29: [function(require2, module3, exports3) {
        "use strict";
        Object.defineProperty(exports3, "__esModule", {
          value: true
        });
          ...
          _createClass(Instructions2, [{
            ...
            value: function render() {
              ...
              this.store.subscribe(function() {
                ...
                var _this$store$getState = _this.store.getState(), routeIndex = _this$store$getState.routeIndex, unit = _this$store$getState.unit, directions = _this$store$getState.directions, error = _this$store$getState.error, compile = _this$store$getState.compile, instructionsOptions = _this$store$getState.instructions;
                ...
                var filterStepsBy = instructionsOptions.showWaypointInstructions ? void 0 : function(step) {
      ...
      }, { "../utils": 34, "lodash.isequal": 11, "lodash.template": 12 }], 30: [function(require2, module3, exports3) {
        "use strict";
        Object.defineProperty(exports3, "__esModule", {
          value: true
        });
        ...
        var MapboxDirections = function() {
          ...
          _createClass(MapboxDirections2, [{
            ...
            value: function onAdd(map) {
              var _this = this;
              this._map = map;
              var _this$_store$getState = this._store.getState(), controls = _this$_store$getState.controls;
            ...
            value: function mapState() {
              var _this2 = this;
              var _this$_store$getState2 = this._store.getState(), profile = _this$_store$getState2.profile, alternatives = _this$_store$getState2.alternatives, congestion = _this$_store$getState2.congestion, styles = _this$_store$getState2.styles, interactive = _this$_store$getState2.interactive, compile = _this$_store$getState2.compile;
            ...
            value: function _areMarkersChangedOnly(state) {
              ...
              MapboxDirections2.SUBSCRIPTION_FIELDS.forEach(function(field) {
                if (_this3._stateSnapshot[field] !== state[field]) {
                  changedSubscriptionFields.push(field);
                }
              });
              return changedSubscriptionFields.length <= MapboxDirections2.MARKER_FIELDS.length && changedSubscriptionFields.every(function(field) {
                return MapboxDirections2.MARKER_FIELDS.includes(field);
              });
            }
          }, {
            ...
            value: function subscribedActions() {
              ...
              this.storeUnsubscribe = this._store.subscribe(function() {
                ...
                var origin = state.origin, destination = state.destination, hoverMarker = state.hoverMarker, directions = state.directions, routeIndex = state.routeIndex;
            ...
            value: function _onSingleClick(e) {
              var _this5 = this;
              var _this$_store$getState3 = this._store.getState(), origin = _this$_store$getState3.origin;
            ...
            value: function _move(e) {
              var _this6 = this;
              var _this$_store$getState4 = this._store.getState(), hoverMarker = _this$_store$getState4.hoverMarker;
              var features2 = this._map.queryRenderedFeatures(e.point, {
            ...
            value: function _onDragUp() {
              if (!this.isDragging) return;
              var _this$_store$getState5 = this._store.getState(), hoverMarker = _this$_store$getState5.hoverMarker, origin = _this$_store$getState5.origin, destination = _this$_store$getState5.destination;
              switch (this.isDragging.layer.id) {
                case "directions-origin-point":
            ...
            value: function removeWaypoint(index) {
              var _this$_store$getState6 = this._store.getState(), waypoints = _this$_store$getState6.waypoints;
        ...
        var _mergeOptions = _interopRequireDefault(require2("merge-options"));
        function _interopRequireDefault(obj) {
          return obj && obj.__esModule ? obj : { "default": obj };
        }
        function _getRequireWildcardCache(nodeInterop) {
        ...
        function data() {
          var state = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : getInitialState();
        ...
        var _default = data;
        exports3["default"] = _default;
      }, { "../constants/action_types.js": 26, "merge-options": 14 }], 34: [function(require2, module3, exports3) {
        "use strict";
        Object.defineProperty(exports3, "__esModule", {
          value: true
        });

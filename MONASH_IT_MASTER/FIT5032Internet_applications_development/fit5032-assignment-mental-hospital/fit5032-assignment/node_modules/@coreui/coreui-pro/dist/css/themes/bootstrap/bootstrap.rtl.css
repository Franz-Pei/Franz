@charset "UTF-8";
/*!
 * CoreUI PRO for Bootstrap  v5.4.0 (https://coreui.io/bootstrap/)
...
[data-bs-theme=light] {
  ...
  --cui-dark-rgb: 33, 37, 41;
  --cui-primary-text-emphasis: #052c65;
  --cui-secondary-text-emphasis: #2b2f32;
  --cui-success-text-emphasis: #0a3622;
  --cui-info-text-emphasis: #055160;
  --cui-warning-text-emphasis: #664d03;
  --cui-danger-text-emphasis: #58151c;
  --cui-light-text-emphasis: #495057;
  --cui-dark-text-emphasis: #495057;
  --cui-primary-bg-subtle: #cfe2ff;
  --cui-secondary-bg-subtle: #e2e3e5;
  --cui-success-bg-subtle: #d1e7dd;
  --cui-info-bg-subtle: #cff4fc;
  --cui-warning-bg-subtle: #fff3cd;
  --cui-danger-bg-subtle: #f8d7da;
  --cui-light-bg-subtle: #fcfcfd;
  --cui-dark-bg-subtle: #ced4da;
  --cui-primary-border-subtle: #9ec5fe;
  --cui-secondary-border-subtle: #c4c8cb;
  --cui-success-border-subtle: #a3cfbb;
  --cui-info-border-subtle: #9eeaf9;
  --cui-warning-border-subtle: #ffe69c;
  --cui-danger-border-subtle: #f1aeb5;
  --cui-light-border-subtle: #e9ecef;
  --cui-dark-border-subtle: #adb5bd;
  ...
  --cui-box-shadow: 0 0.5rem 1rem rgba(0, 0, 0, 0.15);
  --cui-box-shadow-sm: 0 0.125rem 0.25rem rgba(0, 0, 0, 0.075);
  --cui-box-shadow-lg: 0 1rem 3rem rgba(0, 0, 0, 0.175);
  --cui-box-shadow-inset: inset 0 1px 2px rgba(0, 0, 0, 0.075);
  --cui-focus-ring-width: 0.25rem;
  --cui-focus-ring-opacity: 0.25;
  --cui-focus-ring-color: rgba(13, 110, 253, 0.25);
  --cui-form-valid-color: #198754;
...
[data-bs-theme=dark] {
  color-scheme: dark;
  --cui-body-color: #dee2e6;
  --cui-body-color-rgb: 222, 226, 230;
  --cui-body-bg: #212529;
  --cui-body-bg-rgb: 33, 37, 41;
  --cui-emphasis-color: #fff;
  --cui-emphasis-color-rgb: 255, 255, 255;
  --cui-secondary-color: rgba(222, 226, 230, 0.75);
  --cui-secondary-color-rgb: 222, 226, 230;
  --cui-secondary-bg: #343a40;
  --cui-secondary-bg-rgb: 52, 58, 64;
  --cui-tertiary-color: rgba(222, 226, 230, 0.5);
  --cui-tertiary-color-rgb: 222, 226, 230;
  --cui-tertiary-bg: #2b3035;
  --cui-tertiary-bg-rgb: 43, 48, 53;
  --cui-primary-text-emphasis: #6ea8fe;
  --cui-secondary-text-emphasis: #a7acb1;
  --cui-success-text-emphasis: #75b798;
  --cui-info-text-emphasis: #6edff6;
  --cui-warning-text-emphasis: #ffda6a;
  --cui-danger-text-emphasis: #ea868f;
  --cui-light-text-emphasis: #f8f9fa;
  --cui-dark-text-emphasis: #dee2e6;
  --cui-primary-bg-subtle: #031633;
  --cui-secondary-bg-subtle: #161719;
...
.table-primary {
  --cui-table-color: #000;
  --cui-table-bg: #cfe2ff;
  --cui-table-border-color: #a6b5cc;
  --cui-table-striped-bg: #c5d7f2;
  --cui-table-striped-color: #000;
  --cui-table-active-bg: #bacbe6;
  --cui-table-active-color: #000;
  --cui-table-hover-bg: #bfd1ec;
  --cui-table-hover-color: #000;
...
.table-secondary {
  --cui-table-color: #000;
  --cui-table-bg: #e2e3e5;
  --cui-table-border-color: #b5b6b7;
  --cui-table-striped-bg: #d7d8da;
  --cui-table-striped-color: #000;
  --cui-table-active-bg: #cbccce;
  --cui-table-active-color: #000;
  --cui-table-hover-bg: #d1d2d4;
  --cui-table-hover-color: #000;
  color: var(--cui-table-color);
  border-color: var(--cui-table-border-color);
}
...
.table-success {
  --cui-table-color: #000;
  --cui-table-bg: #d1e7dd;
  --cui-table-border-color: #a7b9b1;
  --cui-table-striped-bg: #c7dbd2;
  --cui-table-striped-color: #000;
  --cui-table-active-bg: #bcd0c7;
  --cui-table-active-color: #000;
  --cui-table-hover-bg: #c1d6cc;
  --cui-table-hover-color: #000;
  color: var(--cui-table-color);
  border-color: var(--cui-table-border-color);
}
...
.table-info {
  --cui-table-color: #000;
  --cui-table-bg: #cff4fc;
  --cui-table-border-color: #a6c3ca;
  --cui-table-striped-bg: #c5e8ef;
  --cui-table-striped-color: #000;
  --cui-table-active-bg: #badce3;
  --cui-table-active-color: #000;
  --cui-table-hover-bg: #bfe2e9;
  --cui-table-hover-color: #000;
  color: var(--cui-table-color);
  border-color: var(--cui-table-border-color);
}
...
.table-warning {
  --cui-table-color: #000;
  --cui-table-bg: #fff3cd;
  --cui-table-border-color: #ccc2a4;
  --cui-table-striped-bg: #f2e7c3;
  --cui-table-striped-color: #000;
  --cui-table-active-bg: #e6dbb9;
  --cui-table-active-color: #000;
  --cui-table-hover-bg: #ece1be;
  --cui-table-hover-color: #000;
  color: var(--cui-table-color);
  border-color: var(--cui-table-border-color);
}
...
.table-danger {
  --cui-table-color: #000;
  --cui-table-bg: #f8d7da;
  --cui-table-border-color: #c6acae;
  --cui-table-striped-bg: #eccccf;
  --cui-table-striped-color: #000;
  --cui-table-active-bg: #dfc2c4;
  --cui-table-active-color: #000;
  --cui-table-hover-bg: #e5c7ca;
  --cui-table-hover-color: #000;
  color: var(--cui-table-color);
  border-color: var(--cui-table-border-color);
}
...
.table-light {
  --cui-table-color: #000;
  --cui-table-bg: #f8f9fa;
  --cui-table-border-color: #c6c7c8;
  --cui-table-striped-bg: #ecedee;
  --cui-table-striped-color: #000;
  --cui-table-active-bg: #dfe0e1;
  --cui-table-active-color: #000;
  --cui-table-hover-bg: #e5e6e7;
  --cui-table-hover-color: #000;
  color: var(--cui-table-color);
  border-color: var(--cui-table-border-color);
}
...
.table-dark {
  --cui-table-color: #fff;
  --cui-table-bg: #212529;
  --cui-table-border-color: #4d5154;
  --cui-table-striped-bg: #2c3034;
  --cui-table-striped-color: #fff;
  --cui-table-active-bg: #373b3e;
  --cui-table-active-color: #fff;
  --cui-table-hover-bg: #323539;
...
.form-check-input:checked[type=checkbox] {
  --cui-form-check-bg-image: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 20 20'%3e%3cpath fill='none' stroke='%23fff' stroke-linecap='round' stroke-linejoin='round' stroke-width='3' d='m6 10 3 3 6-6'/%3e%3c/svg%3e");
}
.form-check-input:checked[type=radio] {
  --cui-form-check-bg-image: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='-4 -4 8 8'%3e%3ccircle r='2' fill='%23fff'/%3e%3c/svg%3e");
}
.form-check-input[type=checkbox]:indeterminate {
  background-color: #0d6efd;
  border-color: #0d6efd;
  --cui-form-check-bg-image: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 20 20'%3e%3cpath fill='none' stroke='%23fff' stroke-linecap='round' stroke-linejoin='round' stroke-width='3' d='M6 10h8'/%3e%3c/svg%3e");
}
...
.form-switch .form-check-input {
  --cui-form-switch-bg: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='-4 -4 8 8'%3e%3ccircle r='3' fill='rgba%280, 0, 0, 0.25%29'/%3e%3c/svg%3e");
  width: 2em;
  margin-right: -2.5em;
...
.form-switch .form-check-input:focus {
  --cui-form-switch-bg: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='-4 -4 8 8'%3e%3ccircle r='3' fill='%2386b7fe'/%3e%3c/svg%3e");
}
.form-switch .form-check-input:checked {
  background-position: left center;
  --cui-form-switch-bg: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='-4 -4 8 8'%3e%3ccircle r='3' fill='%23fff'/%3e%3c/svg%3e");
}
...
.was-validated .form-select:valid:not([multiple]):not([size]), .was-validated .form-select:valid:not([multiple])[size="1"], .form-select.is-valid:not([multiple]):not([size]), .form-select.is-valid:not([multiple])[size="1"] {
  --cui-form-select-bg-icon: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 8 8'%3e%3cpath fill='%23198754' d='M2.3 6.73.6 4.53c-.4-1.04.46-1.4 1.1-.8l1.1 1.4 3.4-3.8c.6-.63 1.6-.27 1.2.7l-4 4.6c-.43.5-.8.4-1.1.1z'/%3e%3c/svg%3e");
...
.was-validated .form-select:invalid:not([multiple]):not([size]), .was-validated .form-select:invalid:not([multiple])[size="1"], .form-select.is-invalid:not([multiple]):not([size]), .form-select.is-invalid:not([multiple])[size="1"] {
  --cui-form-select-bg-icon: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 12 12' width='12' height='12' fill='none' stroke='%23dc3545'%3e%3ccircle cx='6' cy='6' r='4.5'/%3e%3cpath stroke-linejoin='round' d='M5.8 3.6h.4L6 6.5z'/%3e%3ccircle cx='6' cy='8.2' r='.6' fill='%23dc3545' stroke='none'/%3e%3c/svg%3e");
  padding-left: 4.125rem;
  background-position: left 0.75rem center, center left 2.25rem;
  background-size: 16px 12px, calc(0.75em + 0.375rem) calc(0.75em + 0.375rem);
}
...
.btn {
  ...
  --cui-btn-box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.15), 0 1px 1px rgba(0, 0, 0, 0.075);
...
.btn-primary {
  ...
  --cui-btn-hover-bg: #0b5ed7;
  --cui-btn-hover-border-color: #0a58ca;
  --cui-btn-focus-shadow-rgb: 49, 132, 253;
  --cui-btn-active-color: #fff;
  --cui-btn-active-bg: #0a58ca;
  --cui-btn-active-border-color: #0a53be;
...
.btn-secondary {
  --cui-btn-color: #fff;
  --cui-btn-bg: #6c757d;
  --cui-btn-border-color: #6c757d;
  --cui-btn-hover-color: #fff;
  --cui-btn-hover-bg: #5c636a;
  --cui-btn-hover-border-color: #565e64;
  --cui-btn-focus-shadow-rgb: 130, 138, 145;
  --cui-btn-active-color: #fff;
  --cui-btn-active-bg: #565e64;
  --cui-btn-active-border-color: #51585e;
  --cui-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
  --cui-btn-disabled-color: #fff;
  --cui-btn-disabled-bg: #6c757d;
  --cui-btn-disabled-border-color: #6c757d;
}
...
.btn-success {
  ...
  --cui-btn-hover-color: #fff;
  --cui-btn-hover-bg: #157347;
  --cui-btn-hover-border-color: #146c43;
  --cui-btn-focus-shadow-rgb: 60, 153, 110;
  --cui-btn-active-color: #fff;
  --cui-btn-active-bg: #146c43;
  --cui-btn-active-border-color: #13653f;
  --cui-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
  --cui-btn-disabled-color: #fff;
...
.btn-info {
  --cui-btn-color: #000;
  --cui-btn-bg: #0dcaf0;
  --cui-btn-border-color: #0dcaf0;
  --cui-btn-hover-color: #000;
  --cui-btn-hover-bg: #31d2f2;
  --cui-btn-hover-border-color: #25cff2;
  --cui-btn-focus-shadow-rgb: 11, 172, 204;
  --cui-btn-active-color: #000;
  --cui-btn-active-bg: #3dd5f3;
  --cui-btn-active-border-color: #25cff2;
  --cui-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
  --cui-btn-disabled-color: #000;
  --cui-btn-disabled-bg: #0dcaf0;
  --cui-btn-disabled-border-color: #0dcaf0;
}
...
.btn-warning {
  ...
  --cui-btn-focus-shadow-rgb: 217, 164, 6;
  --cui-btn-active-color: #000;
  --cui-btn-active-bg: #ffcd39;
  --cui-btn-active-border-color: #ffc720;
  --cui-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
  --cui-btn-disabled-color: #000;
  --cui-btn-disabled-bg: #ffc107;
  --cui-btn-disabled-border-color: #ffc107;
}

.btn-danger {
  --cui-btn-color: #fff;
  --cui-btn-bg: #dc3545;
  --cui-btn-border-color: #dc3545;
  --cui-btn-hover-color: #fff;
  --cui-btn-hover-bg: #bb2d3b;
  --cui-btn-hover-border-color: #b02a37;
  --cui-btn-focus-shadow-rgb: 225, 83, 97;
  --cui-btn-active-color: #fff;
  --cui-btn-active-bg: #b02a37;
  --cui-btn-active-border-color: #a52834;
  --cui-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
  --cui-btn-disabled-color: #fff;
  --cui-btn-disabled-bg: #dc3545;
  --cui-btn-disabled-border-color: #dc3545;
}

.btn-light {
  --cui-btn-color: #000;
  --cui-btn-bg: #f8f9fa;
  --cui-btn-border-color: #f8f9fa;
  --cui-btn-hover-color: #000;
  --cui-btn-hover-bg: #d3d4d5;
  --cui-btn-hover-border-color: #c6c7c8;
  --cui-btn-focus-shadow-rgb: 211, 212, 213;
  --cui-btn-active-color: #000;
  --cui-btn-active-bg: #c6c7c8;
  --cui-btn-active-border-color: #babbbc;
  --cui-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
  --cui-btn-disabled-color: #000;
  --cui-btn-disabled-bg: #f8f9fa;
  --cui-btn-disabled-border-color: #f8f9fa;
}

.btn-dark {
  --cui-btn-color: #fff;
  --cui-btn-bg: #212529;
  --cui-btn-border-color: #212529;
  --cui-btn-hover-color: #fff;
  --cui-btn-hover-bg: #424649;
  --cui-btn-hover-border-color: #373b3e;
  --cui-btn-focus-shadow-rgb: 66, 70, 73;
  --cui-btn-active-color: #fff;
  --cui-btn-active-bg: #4d5154;
  --cui-btn-active-border-color: #373b3e;
  --cui-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
  --cui-btn-disabled-color: #fff;
  --cui-btn-disabled-bg: #212529;
  --cui-btn-disabled-border-color: #212529;
}

.btn-outline-primary {
  --cui-btn-color: #0d6efd;
  --cui-btn-border-color: #0d6efd;
  --cui-btn-hover-color: #fff;
  --cui-btn-hover-bg: #0d6efd;
  --cui-btn-hover-border-color: #0d6efd;
  --cui-btn-focus-shadow-rgb: 13, 110, 253;
  --cui-btn-active-color: #fff;
  --cui-btn-active-bg: #0d6efd;
  --cui-btn-active-border-color: #0d6efd;
  --cui-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
  --cui-btn-disabled-color: #0d6efd;
...
.btn-outline-secondary {
  --cui-btn-color: #6c757d;
  --cui-btn-border-color: #6c757d;
  --cui-btn-hover-color: #fff;
  --cui-btn-hover-bg: #6c757d;
  --cui-btn-hover-border-color: #6c757d;
  --cui-btn-focus-shadow-rgb: 108, 117, 125;
  --cui-btn-active-color: #fff;
  --cui-btn-active-bg: #6c757d;
  --cui-btn-active-border-color: #6c757d;
  --cui-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
  --cui-btn-disabled-color: #6c757d;
  --cui-btn-disabled-bg: transparent;
  --cui-btn-disabled-border-color: #6c757d;
  --cui-gradient: none;
}
...
.btn-outline-success {
  --cui-btn-color: #198754;
  --cui-btn-border-color: #198754;
  --cui-btn-hover-color: #fff;
  --cui-btn-hover-bg: #198754;
  --cui-btn-hover-border-color: #198754;
  --cui-btn-focus-shadow-rgb: 25, 135, 84;
  --cui-btn-active-color: #fff;
  --cui-btn-active-bg: #198754;
  --cui-btn-active-border-color: #198754;
  --cui-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
  --cui-btn-disabled-color: #198754;
  --cui-btn-disabled-bg: transparent;
  --cui-btn-disabled-border-color: #198754;
  --cui-gradient: none;
}
...
.btn-outline-info {
  --cui-btn-color: #0dcaf0;
  --cui-btn-border-color: #0dcaf0;
  --cui-btn-hover-color: #000;
  --cui-btn-hover-bg: #0dcaf0;
  --cui-btn-hover-border-color: #0dcaf0;
  --cui-btn-focus-shadow-rgb: 13, 202, 240;
  --cui-btn-active-color: #000;
  --cui-btn-active-bg: #0dcaf0;
  --cui-btn-active-border-color: #0dcaf0;
  --cui-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
  --cui-btn-disabled-color: #0dcaf0;
  --cui-btn-disabled-bg: transparent;
  --cui-btn-disabled-border-color: #0dcaf0;
  --cui-gradient: none;
}
...
.btn-outline-warning {
  --cui-btn-color: #ffc107;
  --cui-btn-border-color: #ffc107;
  --cui-btn-hover-color: #000;
  --cui-btn-hover-bg: #ffc107;
  --cui-btn-hover-border-color: #ffc107;
  --cui-btn-focus-shadow-rgb: 255, 193, 7;
  --cui-btn-active-color: #000;
  --cui-btn-active-bg: #ffc107;
  --cui-btn-active-border-color: #ffc107;
  --cui-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
  --cui-btn-disabled-color: #ffc107;
  --cui-btn-disabled-bg: transparent;
  --cui-btn-disabled-border-color: #ffc107;
  --cui-gradient: none;
}
...
.btn-outline-danger {
  --cui-btn-color: #dc3545;
  --cui-btn-border-color: #dc3545;
  --cui-btn-hover-color: #fff;
  --cui-btn-hover-bg: #dc3545;
  --cui-btn-hover-border-color: #dc3545;
  --cui-btn-focus-shadow-rgb: 220, 53, 69;
  --cui-btn-active-color: #fff;
  --cui-btn-active-bg: #dc3545;
  --cui-btn-active-border-color: #dc3545;
  --cui-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
  --cui-btn-disabled-color: #dc3545;
  --cui-btn-disabled-bg: transparent;
  --cui-btn-disabled-border-color: #dc3545;
  --cui-gradient: none;
}
...
.btn-outline-light {
  --cui-btn-color: #f8f9fa;
  --cui-btn-border-color: #f8f9fa;
  --cui-btn-hover-color: #000;
  --cui-btn-hover-bg: #f8f9fa;
  --cui-btn-hover-border-color: #f8f9fa;
  --cui-btn-focus-shadow-rgb: 248, 249, 250;
  --cui-btn-active-color: #000;
  --cui-btn-active-bg: #f8f9fa;
  --cui-btn-active-border-color: #f8f9fa;
  --cui-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
  --cui-btn-disabled-color: #f8f9fa;
  --cui-btn-disabled-bg: transparent;
  --cui-btn-disabled-border-color: #f8f9fa;
  --cui-gradient: none;
}
...
.btn-outline-dark {
  --cui-btn-color: #212529;
  --cui-btn-border-color: #212529;
  --cui-btn-hover-color: #fff;
  --cui-btn-hover-bg: #212529;
  --cui-btn-hover-border-color: #212529;
  --cui-btn-focus-shadow-rgb: 33, 37, 41;
  --cui-btn-active-color: #fff;
  --cui-btn-active-bg: #212529;
  --cui-btn-active-border-color: #212529;
  --cui-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
  --cui-btn-disabled-color: #212529;
  --cui-btn-disabled-bg: transparent;
  --cui-btn-disabled-border-color: #212529;
  --cui-gradient: none;
}
...
.btn-link {
  ...
  --cui-btn-hover-border-color: transparent;
  --cui-btn-active-color: var(--cui-link-hover-color);
  --cui-btn-active-border-color: transparent;
  --cui-btn-disabled-color: #6c757d;
  --cui-btn-disabled-border-color: transparent;
  --cui-btn-box-shadow: 0 0 0 #000;
  --cui-btn-focus-shadow-rgb: 49, 132, 253;
  text-decoration: underline;
}
...
.dropdown-menu {
  ...
  --cui-dropdown-link-active-bg: #0d6efd;
  ...
  --cui-dropdown-header-color: #6c757d;
...
.dropdown-menu-dark {
  --cui-dropdown-color: #dee2e6;
  --cui-dropdown-bg: #343a40;
  --cui-dropdown-border-color: var(--cui-border-color-translucent);
  --cui-dropdown-box-shadow: ;
  --cui-dropdown-link-color: #dee2e6;
  --cui-dropdown-link-hover-color: #fff;
  --cui-dropdown-divider-bg: var(--cui-border-color-translucent);
  --cui-dropdown-link-hover-bg: rgba(255, 255, 255, 0.15);
  --cui-dropdown-link-active-color: #fff;
  --cui-dropdown-link-active-bg: #0d6efd;
  --cui-dropdown-link-disabled-color: #adb5bd;
  --cui-dropdown-header-color: #adb5bd;
}
...
.nav-pills {
  ...
  --cui-nav-pills-link-active-bg: #0d6efd;
}
.nav-pills .nav-link {
...
.navbar {
  ...
  --cui-navbar-toggler-icon-bg: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 30 30'%3e%3cpath stroke='rgba%2833, 37, 41, 0.75%29' stroke-linecap='round' stroke-miterlimit='10' stroke-width='2' d='M4 7h22M4 15h22M4 23h22'/%3e%3c/svg%3e");
...
.accordion {
  ...
  --cui-accordion-btn-icon: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='none' stroke='%23212529' stroke-linecap='round' stroke-linejoin='round'%3e%3cpath d='M2 5L8 11L14 5'/%3e%3c/svg%3e");
  ...
  --cui-accordion-btn-active-icon: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='none' stroke='%23052c65' stroke-linecap='round' stroke-linejoin='round'%3e%3cpath d='M2 5L8 11L14 5'/%3e%3c/svg%3e");
  --cui-accordion-btn-focus-box-shadow: 0 0 0 0.25rem rgba(13, 110, 253, 0.25);
...
[data-bs-theme=dark] .accordion-button::after {
  --cui-accordion-btn-icon: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='%236ea8fe'%3e%3cpath fill-rule='evenodd' d='M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z'/%3e%3c/svg%3e");
  --cui-accordion-btn-active-icon: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='%236ea8fe'%3e%3cpath fill-rule='evenodd' d='M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z'/%3e%3c/svg%3e");
}
...
.pagination {
  ...
  --cui-pagination-focus-box-shadow: 0 0 0 0.25rem rgba(13, 110, 253, 0.25);
...
.list-group {
  ...
  --cui-list-group-active-bg: #0d6efd;
  --cui-list-group-active-border-color: #0d6efd;
  display: flex;
  flex-direction: column;
  padding-right: 0;
  margin-bottom: 0;
...
.btn-close {
  ...
  --cui-btn-close-focus-shadow: 0 0 0 0.25rem rgba(13, 110, 253, 0.25);
...
.bs-popover-bottom .popover-header::before, .bs-popover-auto[data-popper-placement^=bottom] .popover-header::before {
  ...
  display: block;
  width: var(--cui-popover-arrow-width);
  margin-right: calc(-0.5 * var(--cui-popover-arrow-width));
  content: "";
...
.offcanvas-header .btn-close {
  ...
  margin: calc(-0.5 * var(--cui-offcanvas-padding-y)) auto calc(-0.5 * var(--cui-offcanvas-padding-y)) calc(-0.5 * var(--cui-offcanvas-padding-x));
}
...
.link-primary:hover, .link-primary:focus {
  color: RGBA(10, 88, 202, var(--cui-link-opacity, 1)) !important;
  -webkit-text-decoration-color: RGBA(10, 88, 202, var(--cui-link-underline-opacity, 1)) !important;
  text-decoration-color: RGBA(10, 88, 202, var(--cui-link-underline-opacity, 1)) !important;
}
...
.link-secondary:hover, .link-secondary:focus {
  color: RGBA(86, 94, 100, var(--cui-link-opacity, 1)) !important;
  -webkit-text-decoration-color: RGBA(86, 94, 100, var(--cui-link-underline-opacity, 1)) !important;
  text-decoration-color: RGBA(86, 94, 100, var(--cui-link-underline-opacity, 1)) !important;
}
...
.link-success:hover, .link-success:focus {
  color: RGBA(20, 108, 67, var(--cui-link-opacity, 1)) !important;
  -webkit-text-decoration-color: RGBA(20, 108, 67, var(--cui-link-underline-opacity, 1)) !important;
  text-decoration-color: RGBA(20, 108, 67, var(--cui-link-underline-opacity, 1)) !important;
}
...
.link-info:hover, .link-info:focus {
  color: RGBA(61, 213, 243, var(--cui-link-opacity, 1)) !important;
  -webkit-text-decoration-color: RGBA(61, 213, 243, var(--cui-link-underline-opacity, 1)) !important;
  text-decoration-color: RGBA(61, 213, 243, var(--cui-link-underline-opacity, 1)) !important;
}
...
.link-warning:hover, .link-warning:focus {
  color: RGBA(255, 205, 57, var(--cui-link-opacity, 1)) !important;
  -webkit-text-decoration-color: RGBA(255, 205, 57, var(--cui-link-underline-opacity, 1)) !important;
  text-decoration-color: RGBA(255, 205, 57, var(--cui-link-underline-opacity, 1)) !important;
}
...
.link-danger:hover, .link-danger:focus {
  color: RGBA(176, 42, 55, var(--cui-link-opacity, 1)) !important;
  -webkit-text-decoration-color: RGBA(176, 42, 55, var(--cui-link-underline-opacity, 1)) !important;
  text-decoration-color: RGBA(176, 42, 55, var(--cui-link-underline-opacity, 1)) !important;
}
...
.link-light:hover, .link-light:focus {
  color: RGBA(249, 250, 251, var(--cui-link-opacity, 1)) !important;
  -webkit-text-decoration-color: RGBA(249, 250, 251, var(--cui-link-underline-opacity, 1)) !important;
  text-decoration-color: RGBA(249, 250, 251, var(--cui-link-underline-opacity, 1)) !important;
}
...
.link-dark:hover, .link-dark:focus {
  color: RGBA(26, 30, 33, var(--cui-link-opacity, 1)) !important;
  -webkit-text-decoration-color: RGBA(26, 30, 33, var(--cui-link-underline-opacity, 1)) !important;
  text-decoration-color: RGBA(26, 30, 33, var(--cui-link-underline-opacity, 1)) !important;
}
...
.calendar {
  ...
  --cui-calendar-cell-focus-box-shadow: 0 0 0 0.25rem rgba(13, 110, 253, 0.25);
...
.callout-primary {
  --cui-callout-border-left-color: #0d6efd;
}

.callout-secondary {
  --cui-callout-border-left-color: #6c757d;
}

.callout-success {
  --cui-callout-border-left-color: #198754;
}

.callout-danger {
  --cui-callout-border-left-color: #dc3545;
}

.callout-warning {
  --cui-callout-border-left-color: #ffc107;
}

.callout-info {
  --cui-callout-border-left-color: #0dcaf0;
}

.callout-light {
  --cui-callout-border-left-color: #f8f9fa;
}

.callout-dark {
  --cui-callout-border-left-color: #212529;
}
...
.header {
  ...
  --cui-header-brand-color: #212529;
  --cui-header-brand-hover-color: #1e2125;
...
.rating:not(.disabled):not(.readonly) .rating-item {
  cursor: pointer;
}
...
.sidebar-toggler {
  ...
  --cui-sidebar-toggler-focus-shadow: 0 0 0 0.25rem rgba(13, 110, 253, 0.25);
...
.time-picker {
  ...
  --cui-time-picker-box-shadow: inset 0 1px 2px rgba(0, 0, 0, 0.075);
  ...
  --cui-time-picker-focus-border-color: #86b7fe;
  --cui-time-picker-focus-box-shadow: 0 0 0 0.25rem rgba(13, 110, 253, 0.25);
...
.time-picker.show .time-picker-dropdown {
  display: block;
}
...
.form-multi-select {
  ...
  --cui-form-multi-select-box-shadow: inset 0 1px 2px rgba(0, 0, 0, 0.075);
  ...
  --cui-form-multi-select-focus-border-color: #86b7fe;
  --cui-form-multi-select-focus-box-shadow: 0 0 0 0.25rem rgba(13, 110, 253, 0.25);
  ...
  --cui-form-multi-select-option-box-shadow: inset 0 1px 2px rgba(0, 0, 0, 0.075);
  --cui-form-multi-select-option-hover-color: var(--cui-body-color);
  --cui-form-multi-select-option-hover-bg: var(--cui-tertiary-bg);
  --cui-form-multi-select-option-focus-box-shadow: 0 0 0 0.25rem rgba(13, 110, 253, 0.25);
  ...
  --cui-form-multi-select-option-selected-indicator-bg: #0d6efd;
  --cui-form-multi-select-option-selected-indicator-bg-image: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 20 20'%3e%3cpath fill='none' stroke='%23fff' stroke-linecap='round' stroke-linejoin='round' stroke-width='3' d='m6 10 3 3 6-6'/%3e%3c/svg%3e");
  --cui-form-multi-select-option-selected-indicator-border-color: #0d6efd;
...
.form-multi-select-option:focus {
  z-index: 5;
  border-color: var(--cui-input-focus-border-color, #86b7fe);
  outline: 0;
  box-shadow: var(--cui-form-multi-select-focus-box-shadow);
}

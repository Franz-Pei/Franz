...
var vue = require('vue');
var index_es = require('../../node_modules/@coreui/icons-vue/dist/index.es.js');
...
const CSmartTable = vue.defineComponent({
    ...
    setup(props, { emit, slots }) {
        ...
        const columnFilterState = vue.ref(props.columnFilterValue ?? {});
        ...
        const tableFilterState = vue.ref(props.tableFilterValue ?? '');
        ...
        const handleSorterChange = (column, index, order) => {
            if (!utils.isSortable(index, props.columns, props.columnSorter, itemsDataColumns.value, columnNames.value)) {
                return;
            }
        ...
        const handleRowChecked = (item, value) => {
            if (value && !isObjectInArray.default(selected.value, item, consts.ITEM_INTERNAL_KEYS)) {
                selected.value = [...selected.value, item];
                return;
            }
            selected.value = selected.value.filter((_item) => !isObjectInArray.default([_item], item, consts.ITEM_INTERNAL_KEYS));
        };
        const handleSelectAllChecked = () => {
            ...
            const selectable = items.value.filter((item) => item._selectable !== false || item._selected === true);
            if (selectable.length === selected.value.length) {
                selected.value = items.value.filter((item) => item._selectable === false && item._selected === true);
                return;
            }
        ...
        const columnNames = vue.computed(() => utils.getColumnNames(props.columns, items.value));
        const itemsDataColumns = vue.computed(() => columnNames.value.filter((name) => utils.getColumnNamesFromItems(items.value).includes(name)));
        const filteredColumns = vue.computed(() => utils.filterColumns(items.value, props.columnFilter, columnFilterState.value, itemsDataColumns.value));
        const filteredTable = vue.computed(() => utils.filterTable(filteredColumns.value, props.tableFilter, tableFilterState.value, itemsDataColumns.value));
        const sortedItems = vue.computed(() => utils.sortItems(props.columnSorter, filteredTable.value, itemsDataColumns.value, sorterState.value));
                ...
                vue.h('div', {
                    ...
                    props.cleaner &&
                        vue.h('div', {
                            ...
                            ? slots.cleanerIcon()
                            : vue.h(index_es.CIcon, { width: '18', content: cilFilterX.cilFilterX }))),
                ]),
            vue.h('div', {
                ...
                default: () => [
                    vue.h(CTable.CTable, {
                        ...
                        default: () => [
                            props.header &&
                                vue.h(CSmartTableHead.CSmartTableHead, {
                                    as: 'head',
                                    ...
                                    sortingIcon: () => slots.sortingIcon
                                        ...
                                        : vue.h('svg', {
                                            ...
                                            viewBox: '0 0 512 512',
                                            role: 'img',
                                            innerHTML: cilSwapVertical.cilSwapVertical[1],
                                        }),
                                    ...
                                    sortingIconAscending: () => slots.sortingIconAscending
                                        ...
                                        : vue.h('svg', {
                                            ...
                                            viewBox: '0 0 512 512',
                                            role: 'img',
                                            innerHTML: cilArrowTop.cilArrowTop[1],
                                        }),
                                    ...
                                    sortingIconDescending: () => slots.sortingIconDescending
                                        ...
                                        : vue.h('svg', {
                                            ...
                                            viewBox: '0 0 512 512',
                                            role: 'img',
                                            innerHTML: cilArrowBottom.cilArrowBottom[1],
                                        }),
                                }),
                            vue.h(CSmartTableBody.CSmartTableBody, {
                            ...
                            Array.isArray(props.footer) &&
                                vue.h(CTableFoot.CTableFoot, {
                                    ...props.tableFootProps,
                                }, {
                                    default: () => vue.h(CTableRow.CTableRow, {}, {
                                        default: () => [
                                            Array.isArray(props.footer) &&
                                                props.footer.map((item) => vue.h(CTableDataCell.CTableDataCell, {
                                                    ...(typeof item === 'object' &&
                    ...
                    props.loading &&
                        vue.h(CElementCover.CElementCover, {
                            boundaries: [
            ...
            (props.pagination || props.itemsPerPageSelect) &&
                vue.h('div', {
                    ...
                    vue.h('div', {
                        ...
                        ? vue.h(CSmartPagination.CSmartPagination, {

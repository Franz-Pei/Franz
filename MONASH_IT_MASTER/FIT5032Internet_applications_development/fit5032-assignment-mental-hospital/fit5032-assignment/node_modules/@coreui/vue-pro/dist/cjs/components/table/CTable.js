...
const CTable = vue.defineComponent({
    ...
    setup(props, { slots, attrs }) {
        const columnNames = vue.computed(() => utils.getColumnNames(props.columns, props.items));
        //   props.columns
        ...
        const table = () => vue.h('table', {
            ...
            default: () => [
                ((props.caption && props.caption !== 'top') || props.captionTop) &&
                    vue.h(CTableCaption.CTableCaption, {}, {
                        default: () => props.caption || props.captionTop,
                    }),
                props.columns &&
                    vue.h(CTableHead.CTableHead, {
                        ...props.tableHeadProps,
                    }, {
                        default: () => vue.h(CTableRow.CTableRow, {}, {
                            default: () => [
                                props.columns &&
                                    props.columns.map((column) => vue.h(CTableHeaderCell.CTableHeaderCell, {
                                        ...(typeof column === 'object' &&
                                            column._props && { ...column._props }),
                                        ...(typeof column === 'object' &&
                                            column._style && { style: { ...column._style } }),
                                    }, {
                                        default: () => utils.getColumnLabel(column),
                                    })),
                            ],
                        }),
                    }),
                props.items &&
                    vue.h(CTableBody.CTableBody, {}, {
                        default: () => [
                            props.items &&
                                props.items.map((item) => vue.h(CTableRow.CTableRow, {

...
import { convertTimeToDate, getAmPm, getLocalizedTimePartials, isValidTime, getSelectedHour, getSelectedMinutes, getSelectedSeconds, convert12hTo24h } from './utils.js';
...
const CTimePicker = defineComponent({
    ...
    setup(props, { emit, attrs, slots }) {
        ...
        watch(date, () => {
            localizedTimePartials.value = getLocalizedTimePartials(props.locale, props.ampm, props.hours, props.minutes, props.seconds);
            if (date.value) {
        ...
        const InputGroup = () => h('div', { class: 'time-picker-input-group' }, [
            h('input', {
                autocomplete: 'off',
                ...
                id: props.id,
                name: props.name,
                onInput: (event) => useDebouncedCallback(() => {
        ...
        const TimePickerSelect = () => [
            ...
            h('select', {
                ...
                localizedTimePartials.value.listOfHours.map((option) => h('option', {
            ...
            props.minutes &&
                h('select', {
                    ...
                    localizedTimePartials.value.listOfMinutes?.map((option) => h('option', {
                        value: option.value.toString(),
                    }, option.label))),
            props.seconds && ':',
            props.seconds &&
                h('select', {
                    ...
                    localizedTimePartials.value.listOfSeconds?.map((option) => h('option', {
                        value: option.value.toString(),
                    }, option.label))),
            localizedTimePartials.value &&
        ...
        return () => h(CFormControlWrapper, {
            ...
            default: () => h(CPicker, {
                ...
                footer: () => h('div', { class: 'time-picker-footer' }, [
                    props.cancelButton &&
                        h(CButton, {

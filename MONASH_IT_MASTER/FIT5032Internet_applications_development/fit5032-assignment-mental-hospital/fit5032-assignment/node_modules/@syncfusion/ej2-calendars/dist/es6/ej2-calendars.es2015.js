    ...
    strictModeUpdate() {
        ...
        if ((this.getModuleName() === 'datetimepicker')) {
            if (this.checkDateValue(this.globalize.parseDate(this.inputElement.value, dateOptions))) {
                const modifiedValue = this.inputElement.value.replace(/(am|pm|Am|aM|pM|Pm)/g, (match) => match.toLocaleUpperCase());
        ...
        if (!this.preventBlur) {
            ...
            if (!isNullOrUndefined(value) && value.trim() !== '') {
                ...
                if (range.length > 1) {
                    ...
                    const start = this.globalize.parseDate(range[0], dateOptions);
                    const end = this.globalize.parseDate(range[1], dateOptions);

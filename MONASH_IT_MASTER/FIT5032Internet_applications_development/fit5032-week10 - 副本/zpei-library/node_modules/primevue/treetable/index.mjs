...
var script$1 = {
  ...
  methods: {
    ...
    onArrowRightKey: function onArrowRightKey(event) {
      ...
      var togglerElement = findSingle(this.$refs.node, '[data-pc-section="rowtogglebutton"]');
    ...
    onArrowLeftKey: function onArrowLeftKey(event) {
      ...
      var togglerElement = findSingle(currentTarget, '[data-pc-section="rowtogglebutton"]');

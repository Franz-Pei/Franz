...
java  -javaagent:jacoco/jacocoagent.jar  -jar junit-platform-console-standalone-1.10.0.jar --class-path /home/out --select-class Subway --select-class SubwayTest 
